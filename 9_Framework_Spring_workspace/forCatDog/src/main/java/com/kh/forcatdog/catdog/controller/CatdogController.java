...
public class CatdogController {
	...
	@RequestMapping("searchCatDog.cc")
	@ResponseBody
	public ArrayList<String> searchCatDog(@RequestBody HashMap<String, String> map) {
		return (ArrayList<String>) ccService.searchCatDog(map);
	}
