		...
		<div class="main">
			...
			<main>
				<div id="container">
					<div class="menu1">	
						<h2>공지사항 수정</h2>
						<form action="nupdate.cs" method="post" onsubmit="return checkIt();">
							<input type="hidden" name="noticeNum" value="${ notice.noticeNum }">
							<input type="hidden" name="memberId" value="${ loginUser.id }">
							<table>
								<tr>
									<td>제목 : </td>
									<td><input type="text" class="input" name="noticeTitle" id="noticeTitle" value="${ notice.noticeTitle }"></td>
								</tr>
								<tr>
									<td>내용 : </td>
									<td>
										<textarea class="input" id="noticeContent" name="noticeContent">${ notice.noticeContent }</textarea>
									</td>
								</tr>
								<tr>
									<td colspan="2" style="text-align:right;">
										<input type="submit" class="button" value="수정하기" style="background-color:#f2ebeb;">
