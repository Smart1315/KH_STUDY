...
<link rel="stylesheet" type="text/css" href="${ contextPath }/resources/css/match/MateUpdate.css">
</head>
<body>
	<div class="wrap">
		...
		<div id='content'>
			...
			<div class="match_content">
				<form action="updateMatch.mc" method="post" role="form" id="formArea" onsubmit="return updatetMatch();">
					...
					<div class="detail_image_area" id="petBlock">
						...
						<div id="pet${ requestScope.mc.petList.size() }" class="petBlock">
							<div class="petArea">
								...
								<div class="m_left" id="petInfo${ requestScope.mc.petList.size() }"></div>
							</div>
					...
					<button class="returnListBtn" onclick="location.href='findMatchList.mc?cate=2'">
