...
public class Member {
	...
	// + member()
	// + member(memberId : String, memberPwd : String, memberName : String, gender :
	// char, email : String, phone : String, age : int, address : String)
	// + member(memberId : String, memberPwd : String, memberName : String, gender :
	// char, email : String, phone : String, age : int, address : String, enrollDate
	// : Date)

	// + getter/setter
	// + toString : String
	// memberId, meberPwd, memberName, gender, email, phone, address, age,
	// enrollDate
