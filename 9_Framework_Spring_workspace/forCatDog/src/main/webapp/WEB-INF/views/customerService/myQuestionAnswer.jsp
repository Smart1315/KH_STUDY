      ...
      <div class="main">
         ...
         <main>
            <div id="container">
               <span class="menu1">   
                  <h2>1:1문의 답변</h2>
                  <form method="post" action="myQuestionAnswer.cs">
                  <input type="hidden" name="memberId" value="${ loginUser.id }">
                  <input type="hidden" value="${ qna.qnaNum }" name="qnaNum">
                  <input type="hidden" value="${ qna.qnaOrder }" name="qnaOrder">
                  <input type="hidden" value="${ qna.qnaIndent }" name="qnaIndent">
                     <table>
                        <tr>
                           <td>제목 : </td>
                           <td><input type="text" class="input" name="title" id="noticeTitle" value="[Re] : ${ qna.title }"></td>
                        </tr>
                        <tr>
                           <td>내용 : </td>
                           <td>
                              <textarea class="input" name="content" id="noticeContent">${ qna.content }&#10;&#10;&#10;&#10;---------------------------------------------------------------------------------&#10;</textarea>
                           </td>
                        </tr>
                        <tr>
                           <td colspan="2" style="text-align:right;">
                              <input type="submit" class="button" value="작성하기" style="background-color:#f2ebeb;">
                              <input type="button" class="button" onclick="location.href='javascript:history.go(-1)'" value="취소하기">
                           </td>
                        </tr>
                     </table>
                  </form>
