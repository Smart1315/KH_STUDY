...
public class Comment {
	...
	public Comment(int c_num, int c_Gnum, int g_order, int c_level, int b_num, String member_id, String nickName,
	...
	public String toString() {
		return "Comment [c_num=" + c_num + ", c_Gnum=" + c_Gnum + ", g_order=" + g_order + ", c_level=" + c_level
				+ ", b_num=" + b_num + ", member_id=" + member_id + ", nickName=" + nickName + ", c_content="
