...
<body>
	<div class="wrap">
		...
		<div id='content'>
			...
			<form action="sellWrite.ss" method="post" enctype="Multipart/form-data" onsubmit="return sellshareInsert();">
            ...
            <input type="text" id="name" placeholder="가격(&#8361)" name="price">
			...
			<div id="imageArea" name="imageSelect">
