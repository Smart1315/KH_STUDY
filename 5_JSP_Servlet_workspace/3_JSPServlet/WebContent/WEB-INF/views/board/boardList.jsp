	...
	<div class="outer">
		...
		<div class="pagingArea" align="center">
			...
			<% for(int p = startPage; p <= endPage; p++) { %>
				...
				<% } else { %>
					<button id="numBtn" onclick="location.href='<%= request.getContextPath() %>/list.bo?currentPage=<%= p %>'" id=><%= p %></button>
				<% } %>
			<% } %>
	...
	<script>
		$(function() {
			$("#listArea td").mouseenter(function() {
				...
				location.href = '<%= request.getContextPath() %>/boardDetail.bo?no=' + num;
			});
		});
	</script>
</body>
