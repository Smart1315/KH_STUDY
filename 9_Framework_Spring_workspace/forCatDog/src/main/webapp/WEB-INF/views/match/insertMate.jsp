...
<link rel="stylesheet" type="text/css" href="${ contextPath }/resources/css/match/InsertMate.css">
   ...
   <div class="wrap">
      ...
      <div id='content'>
         ...
         <form action="insertMatch.mc" method="post" enctype="multipart/form-data" role="form" onsubmit="return InmatchInsert();">
            <input type="hidden" name="matchCate" value="2">
            ...
            <button type="button" class="returnListBtn" onClick="location.href='${ contextPath }/findMatchList.mc?cate=2'">
