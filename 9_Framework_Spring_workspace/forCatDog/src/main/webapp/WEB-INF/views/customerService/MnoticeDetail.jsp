			...
			<main>
				<div id="container">
					<span class="menu1">	
						...
						<tr>
							<td>작성자 : ${ notice.nickName } | 작성날짜 : <fmt:formatDate value='${ notice.createDate }' pattern="yyyy-MM-dd HH:mm"/> | 조회수 ${ notice.noticeCount } 
								<c:url var="Mlist" value="managerMain.mn">
								</c:url>
								<input type="button" value="목록" id="Lbtn" onclick="location.href='${ Mlist }'"></td>
						</tr>
						<tr>
							<td><textarea id="detailtext" readonly>${ notice.noticeContent }</textarea></td>
						</tr>
						...
						<tr>
							<td>
								<input type="button" value="수정" id="Mbtn" onclick="location.href='${ nupdate }'">
								<input type="button" value="삭제" id="Dbtn" id="delete" onclick="location.href='${ ndelete }'">
							</td>
						</tr>
						</table>
					</span>
