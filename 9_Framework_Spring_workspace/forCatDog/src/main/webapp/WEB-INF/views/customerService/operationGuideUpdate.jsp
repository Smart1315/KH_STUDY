		...
		<div class="main">
			...
			<main>
				<div id="container">
					<div class="menu1">	
						<h2>이용안내 수정</h2>
						<form action="operationUpdate.cs" method="post">
							<input type="hidden" name="opNum" value="${ op.opNum}">
							
							<table>
								<tr>
									<td>제목 : </td>
									<td><input type="text" class="input" name="title" id="noticeTitle" value="${ op.title }"></td>
								</tr>
								<tr>
									<td>내용 : </td>
									<td>
										<textarea class="input" id="noticeContent" name="content">${ op.content }</textarea>
									</td>
								</tr>
								<tr>
