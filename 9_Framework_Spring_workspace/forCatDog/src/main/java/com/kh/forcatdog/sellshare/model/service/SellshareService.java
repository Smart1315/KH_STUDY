...
public interface SellshareService {
	...
	List<Sellshare> selectShareList(PageInfo pi);
	...
	int getInfoSSListCount(HashMap<String, String> map);

	List<Sellshare> selectInfoSSList(HashMap<String, String> map, PageInfo pi);
}
