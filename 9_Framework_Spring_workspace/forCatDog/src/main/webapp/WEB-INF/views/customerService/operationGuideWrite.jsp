		...
		<div class="main">
			...
			<main>
				<div id="container">
					<span class="menu1">	
						<h2>이용안내 작성</h2>
						<form action="operationWrite.cs" method="post">
						<input type="hidden" name="memberId" value="${ loginUser.id }">
							<table>
								<tr>
									<td>제목 : </td>
									<td><input type="text" class="input" name="Title" id="opTitle"></td>
								</tr>
								<tr>
									<td>내용 : </td>
									<td>
										<textarea class="input" name="Content" id="opContent"></textarea>
									</td>
								</tr>
								<tr>
