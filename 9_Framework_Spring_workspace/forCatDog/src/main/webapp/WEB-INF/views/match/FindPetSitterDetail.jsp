...
<link rel="stylesheet" type="text/css" href="${ contextPath }/resources/css/match/FindPetSitterDetail.css">
</head>
<body>
	<div class="wrap">
		...
		<div id='content'>
			...
			<div class="match_content">
				...
				<div class="important">
					...
					<p class="important_content">
						* 펫 시터 시험에 통과하신 분만 신청하실 수 있습니다.
					</p>
				</div>
	...
	<script>
		function matchingPopup(){
			<c:if test='${ sessionScope.loginUser.petQ == "Y" }'>
			var popupX = (window.screen.width / 2) - (377 / 2);
			var popupY = (window.screen.height / 2) - (330 / 2);
		
			window.open("", "MatchingPopup",'status=no, height=500, width=540, left='+ popupX + ', top='+ popupY);
