 ...
 * Generated at: 2020-10-16 08:41:08 UTC
...
public final class boardWriteForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) { 
      ...
      out.print( request.getContextPath() );
      out.write("/insert.bo\" method=\"post\" onsubmit=\"return boardCheck();\">\r\n");
      out.write("\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>분야</th>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\tconsole.log(document.getElementsByName('category'));\r\n");
      out.write("\t\t\tfor(var i = 0; i < category.children.length; i++) {\r\n");
      out.write("\t\t\t\tconsole.log(category.children[i].selected);\r\n");
