...
public class MemberDAO {
		...
		try {
			...
			if (rset.next()) {
				loginUser = new Member(rset.getString("USER_ID"), rset.getString("USER_PWD"),
						...
						rset.getString("EMAIL"), rset.getNString("ADDRESS"), rset.getString("INTEREST"),
		...
		try {
			...
			if (rset.next()) {
				member = new Member(rset.getString("USER_ID"), rset.getString("USER_PWD"), rset.getString("USER_NAME"),
						...
						rset.getNString("ADDRESS"), rset.getString("INTEREST"), rset.getDate("ENROLL_DATE"),
	...
	public int updatePwd(Connection conn, Member myInfo, String newPwd) {
		PreparedStatement pstmt = null;
		int result = 0;
		...
		try {
			...
			pstmt.setString(3, myInfo.getUserPwd());
