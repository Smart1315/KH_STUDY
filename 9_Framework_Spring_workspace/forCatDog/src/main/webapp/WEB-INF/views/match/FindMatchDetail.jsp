...
<link rel="stylesheet" type="text/css" href="${ contextPath }/resources/css/match/FindMatchDetail.css">
...
<!-- 				<hr> -->
				...
				<div class="btnArea">
					<button class="returnListBtn" onClick="location.href='${ contextPath }/findMatchList.mc?cate=${ mc.matchCate }'">
